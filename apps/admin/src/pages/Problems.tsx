...
// // API: GET /problems → returns all problems for this admin
// // API: POST /problems → create problem (returns generated code like PROB001)
...
// type Problem = {
//   id: number
//   code: string           // unique code e.g. PROB001 — used to add to contest
//   title: string
...
//   {
//     id: 1, code: 'PROB001', title: 'Two Sum', difficulty: 'Easy', tags: ['Array', 'Hash Map'],
...
//   },
//   {
//     id: 2, code: 'PROB002', title: 'Reverse Linked List', difficulty: 'Easy', tags: ['Linked List'],
...
//     testCases: [{ input: '1 2 3 4 5', output: '5 4 3 2 1', explanation: 'Reverse of [1,2,3,4,5]' }],
//     createdAt: '2026-03-02',
//   },
//   {
//     id: 3, code: 'PROB003', title: 'Valid Parentheses', difficulty: 'Medium', tags: ['Stack', 'String'],
...
// const EMPTY_PROBLEM: Omit<Problem, 'id' | 'createdAt' | 'code'> = {
...
// // Generate next problem code
// function nextCode(problems: Problem[]): string {
//   const nums = problems.map(p => parseInt(p.code.replace('PROB', ''), 10)).filter(n => !isNaN(n))
...
//         ...form,
//         id: Date.now(),
//         code: nextCode(problems),   // auto-generate code
...
//               {filtered.length === 0 && <div className="empty-problems">No problems found</div>}
//               {filtered.map((p, i) => (
...
//                     {/* Problem code — clickable to copy */}
//                     <button
...
// const EMPTY_FORM = {
//   title: '', difficulty: 'Easy' as const, tags: [] as string[],
//   description: '', inputFormat: '', outputFormat: '',
//   constraints: '', testCases: [{ input: '', output: '', explanation: '' }],
// }
type FormState = {
